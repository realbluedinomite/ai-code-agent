 ...
 * 
 * Usage:
 *   node scripts/test-setup.js                    # Run all checks
 *   node scripts/test-setup.js --env             # Check environment only
 *   node scripts/test-setup.js --deps            # Check dependencies only
 *   node scripts/test-setup.js --db              # Check database only
 *   node scripts/test-setup.js --groq            # Check Groq API only
 *   node scripts/test-setup.js --components      # Check component health only
 *   node scripts/test-setup.js --verbose         # Verbose output
 *   node scripts/test-setup.js --fix             # Attempt to fix issues automatically
 */
